 ...
 * dac-cosine.h
 *
 * Borrowed from https://github.com/krzychb/dac-cosine
 *
 */

#ifndef COMPONENTS_DAC_DAC_COSINE_H_
#define COMPONENTS_DAC_DAC_COSINE_H_
...
#endif /* COMPONENTS_DAC_DAC_COSINE_H_ */
